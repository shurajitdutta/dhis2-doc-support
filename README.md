...
1. Merge to make your contribution officially available and ready for translation
 ...
 > **Note**
 >
 > This document has been written in Markdown and is available on [Github][repo]. I quickly converted in [.html, .pdf and .docx][5] using [pandoc][10]. It literally took me a couple of minutes to convert it.
